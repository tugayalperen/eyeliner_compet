  ...
  unsigned int chartFileNumber, const char* specsCksum, int_T method, void *data)
{
  if (chartFileNumber==3) {
    c3_flightControlSystem_method_dispatcher(simstructPtr, method, data);
    return 1;
  }
  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
  ...
  if (nrhs>1 && mxIsChar(prhs[1])) {
    ...
    if (!strcmp(commandName,"machine")) {
       ...
       case 3:
        {
          ...
          sf_c3_flightControlSystem_get_check_sum(plhs);
          break;
        }
      ...
      ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(4146247934U);
      ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2075065218U);
      ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1394238724U);
      ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3587651100U);
    } else {
      return 0;
    }
  } else {
    ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1632435567U);
    ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(559578504U);
    ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1662636953U);
    ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3874252496U);
  }
  ...
  mxArray * plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 3:
      {
        if (strcmp(instanceChksum, "sSFfOtAjS0okH9jZnnbtDoG") == 0) {
          extern const mxArray
            *sf_c3_flightControlSystem_get_eml_resolved_functions_info(void);
          mxArray *persistentMxArray = (mxArray *)
            sf_c3_flightControlSystem_get_eml_resolved_functions_info();
  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 3:
      {
        if (strcmp(tpChksum, "sSFfOtAjS0okH9jZnnbtDoG") == 0) {
          extern mxArray *sf_c3_flightControlSystem_third_party_uses_info(void);
          plhs[0] = sf_c3_flightControlSystem_third_party_uses_info();
          break;
        }
      }
...

  {
    ...
    switch (chartFileNumber) {
     case 3:
      {
        if (strcmp(tpChksum, "sSFfOtAjS0okH9jZnnbtDoG") == 0) {
          extern mxArray *sf_c3_flightControlSystem_jit_fallback_info(void);
          plhs[0] = sf_c3_flightControlSystem_jit_fallback_info();
          break;
        }
      }
     ...
     case 3:
      {
        if (strcmp(tpChksum, "sSFfOtAjS0okH9jZnnbtDoG") == 0) {
          ...
          const char* encoded_post_codegen_info =
            sf_c3_flightControlSystem_get_post_codegen_info();
...

  {
    ...
    switch (chartFileNumber) {
     case 3:
      {
        if (strcmp(tpChksum, "sSFfOtAjS0okH9jZnnbtDoG") == 0) {
          extern mxArray *sf_c3_flightControlSystem_updateBuildInfo_args_info
            (void);
          plhs[0] = sf_c3_flightControlSystem_updateBuildInfo_args_info();
          break;
        }
      }
